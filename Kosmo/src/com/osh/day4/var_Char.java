...
public class var_Char {
	public static void main(String[] args) {
		/* char 형 : char형은 자바가 .unicode를 기반에두기 때문에 2 Byte를 쓴다. 1바이트를 쓰면 아스키 코드와 호환되고, 그외에 문자들은 유니코드와 호환된다.
		 아스키 코드는 영문 대소문자, 특수문자, 숫자를 표기할수있다.
		 유니코드는 아스키 코드를 포함해 한글, 한자 등등을 표기할수있다.
		 문자를 변수에 저장하면 그 문자에 해당하는 정수값(아스키 코드, 유니코드 등) 이 저장된다.
		 */
		...
		char ch = '\uD55C'; // (16진수)D55C = 한 = 54620(10진수), \(유니코드의 escape sequence 형식)u + 16진수 > 유니코드 표현방식.
